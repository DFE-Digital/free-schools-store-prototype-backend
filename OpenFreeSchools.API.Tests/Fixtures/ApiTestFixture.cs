...
using OpenFreeSchools.Service.Base;
...
namespace OpenFreeSchools.API.Tests.Fixtures
{
	public class ApiTestFixture : IDisposable
	{
		private readonly WebApplicationFactory<OpenFreeSchools.API.Startup> _application;

		public HttpClient Client { get; init; }

		private DbContextOptions<OpenFreeSchoolsDbContext> _dbContextOptions { get; init; }
		...
		public ApiTestFixture()
		{
			lock (_lock)
			{
				if (!_isInitialised)
				{
					...
					_dbContextOptions = new DbContextOptionsBuilder<OpenFreeSchoolsDbContext>()
		...
		public OpenFreeSchoolsDbContext GetContext() => new OpenFreeSchoolsDbContext(_dbContextOptions, _serverUserInfoService);
